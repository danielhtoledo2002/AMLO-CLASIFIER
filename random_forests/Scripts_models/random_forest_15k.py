...
from Text_Processing import text_pro_15k as text_pro

# import text_procesing

model = joblib.load("Modelos_guardados/random_for_15k.joblib")
tfidf = joblib.load("Modelos_guardados/tfidf_vectorizer_15k.joblib")
clasification = pd.read_csv("Clasificaciones/clasification_15k.csv")
