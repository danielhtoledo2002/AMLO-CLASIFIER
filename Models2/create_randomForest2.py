...
clasification.to_csv("random_for/clasification3.csv")


print(classification_report(y_test, y_pred))
joblib.dump(model, "random_for/random_forr3.joblib")
joblib.dump(tfidf, "random_for/tfidf_vectorizer3.joblib")
