...
new_model = keras.models.load_model('DeepLearningModels/CNN_model.keras')
scaler = joblib.load('DeepLearningModels/scaler.save')
clasification = pd.read_csv("score_DLModels/clasificationCNN.csv")
